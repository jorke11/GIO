...
class Presupuesto extends Conexion{
    ...
    public function get_requi($con){
        ...
        $sql="SELECT a.Id,a.Consecutivo,a.Fr,a.Estadodoc,g.Lista,Centrocosto,u.Centro_costo,Observaciones,s.Nombre
        FROM Ope_presupuesto as a 
    ...
    public function guardar_registro(){
        ...
        $sql="UPDATE Ope_presupuesto set 
        Observaciones='".$_POST["Observaciones"]."'
        WHERE Consecutivo=".$_POST["Id"]." 
        AND Centrocosto=".$_SESSION["id_centro"];
        mysql_query($sql);
        header("Location:".Conexion::ruta()."Ope_presupuesto?b=".$_POST["Id"]);
    }
