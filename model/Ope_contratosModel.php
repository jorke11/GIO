...
class Contratos extends Conexion{
    ...
    public function agregar_contratista(){
        
            Conexion::conectar();
            

            $sql="INSERT INTO Ope_Contratistas(Cednit,Nombre)
                    VALUES(".$_POST["Cednit"].",'".$_POST["Nombre"]."')";
            mysql_query($sql);
            echo "<script>location.href='".Conexion::ruta()."Ope_contratos'</script>";
